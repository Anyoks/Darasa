...
class ExamsControllerTest < ActionController::TestCase
  ...
  test "should create exam" do
    assert_difference('Exam.count') do
      post :create, exam: { attachment: @exam.attachment, date: @exam.date, unit_name: @exam.unit_name }
    end
  ...
  test "should update exam" do
    patch :update, id: @exam, exam: { attachment: @exam.attachment, date: @exam.date, unit_name: @exam.unit_name }
    assert_redirected_to exam_path(assigns(:exam))
  end
